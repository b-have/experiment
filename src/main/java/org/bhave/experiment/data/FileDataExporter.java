...
public class FileDataExporter extends AbstractDataExporter {
    ...
    public void exportRecord(List<String> data) {
        ...
        if (currentFile == null) {
            ...
            try {
                writer = new BufferedWriter(new FileWriter(currentFile, config.getBoolean(P_APPEND)));
            } catch (IOException ex) {
                Logger.getLogger(FileDataExporter.class.getName()).log(Level.SEVERE, "File data exporter failled to create the file writter", ex);
            }
        }
        ...
        if (numExported == 0 && columns != null) {
            try {
                ...
                Logger.getLogger(FileDataExporter.class.getName()).log(Level.SEVERE, "could not write the file header", ex);
            }
        }
        ...
        try {
            ...
            Logger.getLogger(FileDataExporter.class.getName()).log(Level.SEVERE, "could not write the data record " + numExported, ex);
        }
     ...
     *
     * @param config a configuration object to be used for this file data
     * exporter
     */
    @Override
    ...
    public void finish() {
        if (writer != null) {
            try {
                ...
                Logger.getLogger(FileDataExporter.class.getName()).log(Level.SEVERE, "data exporter failled to close the file writer", ex);
            }
        }
    }
