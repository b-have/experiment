 ...
 * @author Davide Nunes
 */
public abstract class AbstractDataConsumer extends AbstractConfigurablePrototype<DataConsumer> implements DataConsumer {
    ...
    public Map<String, Class<? extends Object>> getConfigurableParameters() {
        Map<String, Class<? extends Object>> params = super.getConfigurableParameters();
    ...
    public void loadConfiguration(Configuration config) {
        if (!config.containsKey(P_PRODUCER_ID)) {
            throw new RuntimeException("Invalid configuration for data consumer. Please supply a value for the property:" + P_PRODUCER_ID);
        }
